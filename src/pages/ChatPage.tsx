...
export default function ChatPage() {
  ...
  // Визуальный debug прямо на странице
  const debugInfo = (
    <div style={{background:'#eef',padding:8,fontSize:12,marginBottom:8}}>
      <b>DEBUG ChatPage:</b>
      <pre>{JSON.stringify({ user, chatId, loading, otherUser, messagesLength: messages.length, pathname: window.location.pathname, href: window.location.href, bodyClass: document.body.className }, null, 2)}</pre>
    </div>
  );
