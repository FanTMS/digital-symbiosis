...
import { Bell, Moon, Sun, Globe, Shield, CreditCard, HelpCircle, ChevronRight, ToggleLeft as Toggle } from 'lucide-react';
              ...
              {group.settings.map((setting, settingIndex) => (
                ...
                >
                  ...
                  {setting.type === 'toggle' ? (
                    ...
                    <button onClick={setting.onClick} className="flex items-center">
