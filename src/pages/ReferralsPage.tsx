...
const ReferralsPage: React.FC = () => {
  ...
  const getReferralStatusInfo = (status: string) => {
    switch (status) {
      case 'invited':
        return { color: 'text-yellow-500', bgColor: 'bg-yellow-100', label: 'Приглашен' };
      case 'registered':
        return { color: 'text-blue-500', bgColor: 'bg-blue-100', label: 'Зарегистрирован' };
      case 'active':
        return { color: 'text-green-500', bgColor: 'bg-green-100', label: 'Активен' };
      default:
        return { color: 'text-gray-500', bgColor: 'bg-gray-100', label: 'Неизвестно' };
    }
  };
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="text-xs text-gray-500">
                        {referral.created_at ? new Date(referral.created_at).toLocaleString() : ''}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center">
