...
const ProfilePage: React.FC = () => {
  ...
  const ALL_TABS = TABS;
  const ownAllowedTabs = ALL_TABS;
  const otherAllowedTabs = ALL_TABS.filter(t => ['services', 'reviews'].includes(t.id));
  ...
  const visibleTabs = isOwn ? ownAllowedTabs : otherAllowedTabs;
