...
export default function QuizEditor({ quiz, questions: initialQuestions, onSave }: QuizEditorProps) {
    ...
    return (
        <div className="max-w-xl w-full mx-auto p-2 sm:p-6 bg-white rounded-xl shadow min-h-[80vh] flex flex-col">
            ...
            {/* Кнопка 'Добавить вопрос' для десктопа */}
            <div className="hidden md:block mb-6">
                <Button variant="outline" className="w-full py-2 rounded-xl" onClick={addQuestion}>Добавить вопрос</Button>
            </div>
            {/* Кнопка 'Добавить вопрос' фиксированная для мобильных */}
            <div className="md:hidden fixed left-0 right-0 bottom-[70px] z-40 px-2 pb-2 animate-fade-in">
                <Button variant="outline" onClick={addQuestion} fullWidth className="py-3 text-base rounded-2xl shadow-xl">Добавить вопрос</Button>
            </div>
