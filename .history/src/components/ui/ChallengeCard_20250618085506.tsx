...
const ChallengeCard: React.FC<ChallengeCardProps> = ({
    ...
    return (
        <div
            className={`group relative rounded-3xl overflow-hidden cursor-pointer transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl bg-white border border-gray-100 ${className} shadow-md md:shadow-xl min-h-[160px] md:min-h-[260px] flex flex-row md:flex-col justify-end`}
            onClick={onClick}
        >
            {/* Оверлей завершён */}
