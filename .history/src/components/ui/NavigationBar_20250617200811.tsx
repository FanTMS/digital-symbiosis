...
const NavigationBar: React.FC = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 left-1/2 -translate-x-1/2 max-w-md w-full z-50 bg-white backdrop-blur-lg shadow-lg border-t border-gray-200 navigation-bar-fixed"
