      ...
      <div className="flex-1 flex flex-col p-3 gap-2">
        ...
        <div className="flex items-center justify-between mt-auto pt-1">
          <div className="flex items-center gap-1">
            ...
            >
              <Avatar src={user.avatar_url} name={user.name} size={24} className="border border-gray-200 shadow-sm group-hover/avatar:ring-2 group-hover/avatar:ring-blue-400 transition" />
              <span className="text-[11px] text-gray-700 font-medium truncate max-w-[60px] group-hover/avatar:underline group-hover/avatar:text-blue-600 transition flex items-center gap-0.5">
                {user.name}
