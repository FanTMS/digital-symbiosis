            ...
            <div className="relative h-48 overflow-hidden bg-gradient-to-br from-primary-100 to-accent-100">
                {image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <Trophy size={64} className="text-primary-300" />
                    </div>
                )}
                ...
                <div className="absolute top-3 right-3 flex flex-col gap-2 items-end">
                    {isLimitReached && !timeRemaining.expired && (
                        <span className="bg-error-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                            Лимит достигнут
                        </span>
                    )}
                ...
                <div className="flex items-center justify-between mb-4">
                    {prize && (
                        <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-warning-100 to-warning-200 flex items-center justify-center">
                                <Gift size={16} className="text-warning-600" />
                            </div>
                            <div>
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 text-sm">
                            ...
                            <span className={`font-medium ${timeRemaining.expired ? 'text-gray-500' : 'text-primary-600'}`}>
                                {timeRemaining.text}
                            </span>
                        </div>
                    ...
                    <div className="relative h-2 bg-gray-200 rounded-full overflow-hidden">
                        <motion.div
                            className="absolute inset-y-0 left-0 bg-gradient-to-r from-primary-400 to-accent-500"
                            initial={{ width: 0 }}
