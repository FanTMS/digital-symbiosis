...
const NavigationBar: React.FC = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 left-1/2 -translate-x-1/2 max-w-lg w-full z-50 bg-white backdrop-blur-lg shadow-lg px-2 border-t border-gray-200 navigation-bar-fixed"
      style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 20px) + 8px)" }}
    >
      <div className="flex justify-between items-center w-full min-h-[64px] py-1">
        {navItems.map((item) => {
