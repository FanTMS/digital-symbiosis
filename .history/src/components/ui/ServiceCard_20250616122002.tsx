    ...
    >
      ...
      <div className="flex-1 flex flex-col p-3 gap-2">
        <div className="flex items-center justify-between mb-1 gap-1 min-h-[22px]">
          <span className="flex items-center gap-1 text-[10px] font-semibold bg-blue-50 text-blue-700 px-1.5 py-0.5 rounded max-w-[60%] truncate">
        ...
        <div className="flex items-center justify-between mt-auto pt-1">
          <div className="flex items-center gap-1">
            ...
            />
            <span className="text-[11px] text-gray-700 font-medium truncate max-w-[60px]">{user.name}</span>
          </div>
