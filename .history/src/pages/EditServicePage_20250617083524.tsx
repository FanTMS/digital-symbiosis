            ...
            <div className="w-full max-w-xl bg-white rounded-2xl shadow-2xl p-4 sm:p-8 flex flex-col gap-6 relative">
                <div className="flex items-center justify-between mb-4 sticky top-0 z-30 bg-white rounded-t-2xl pt-2 pb-2 px-1 shadow-sm">
                    ...
                    <div className="flex-1 flex items-center justify-center">
                        <h2 className="text-lg sm:text-xl font-extrabold text-blue-900 flex items-center gap-2"><FileEdit size={20} /> Редактировать услугу</h2>
                    </div>
                    <div className="flex gap-2 items-center ml-2">
                        <button
                            onClick={handleSave}
                            disabled={saving}
                            className="p-2 rounded-full bg-blue-100 hover:bg-blue-200 active:bg-blue-300 text-blue-700 shadow transition disabled:opacity-60"
                            title="Сохранить"
                        >
                            <svg width="22" height="22" fill="none" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                        </button>
                        <button
                            onClick={() => setShowDeleteModal(true)}
                            disabled={saving}
                            className="p-2 rounded-full bg-red-100 hover:bg-red-200 active:bg-red-300 text-red-600 shadow transition disabled:opacity-60"
                            title="Удалить услугу"
                        >
                            <svg width="22" height="22" fill="none" viewBox="0 0 24 24"><path d="M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2m2 0v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6h16z" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                        </button>
                    </div>
                </div>
