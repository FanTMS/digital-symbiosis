    ...
    <div className="pb-20 pt-2 min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-white flex justify-center items-start overflow-auto">
      <div className="w-full max-w-md mx-auto px-2 sm:px-0">
        ...
        >
          ...
          {/* Role select */}
          <div className="mb-5">
            <label className="block font-semibold mb-1 text-gray-700">Тип услуги</label>
            <div className="flex gap-2">
              <button
                type="button"
                className={`flex-1 py-2 rounded-lg border ${role === 'provider' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-700'} font-semibold transition`}
              ...
              <button
                type="button"
                className={`flex-1 py-2 rounded-lg border ${role === 'client' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-700'} font-semibold transition`}
