        ...
        <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-white flex flex-col items-center py-4 px-2 sm:px-0">
            <div className="w-full max-w-xl bg-white rounded-2xl shadow-2xl p-4 sm:p-8 flex flex-col gap-6 relative">
                <div className="flex items-center justify-between mb-4 sticky top-0 z-30 bg-white rounded-t-2xl pt-2 pb-2 px-1 shadow-sm">
                    <button onClick={() => navigate(`/services/${service.id}`)} className="flex items-center gap-2 text-blue-700 hover:text-blue-900 font-medium">
                        <ChevronLeft size={22} /> <span>К услуге</span>
                    </button>
                    <h2 className="text-xl sm:text-2xl font-extrabold text-blue-900 flex items-center gap-2 justify-center"><FileEdit size={24} /> Редактировать услугу</h2>
                ...
                <div className="flex flex-col gap-4 mt-2 overflow-y-auto max-h-[70vh] pb-4">
                    <div>
