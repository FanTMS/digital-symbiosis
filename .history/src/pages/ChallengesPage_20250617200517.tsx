        ...
        <div className="max-w-2xl mx-auto p-4">
            ...
            {isLoading ? (
                ...
                <div className="space-y-6">
                    {filtered.map((ch: any) => (
                        <div key={ch.id} className="bg-white rounded-2xl shadow-lg p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 hover:shadow-xl transition-all duration-200">
                            <div>
                                <div className="font-bold text-xl mb-1 text-primary-700">{ch.title}</div>
                                <div className="text-gray-500 text-base mb-1">{ch.description}</div>
                            ...
                            <div className="flex flex-col gap-2 md:items-end">
                                ...
                                <Button variant="outline" className="rounded-xl px-5 font-semibold" onClick={() => navigate(`/challenges/${ch.id}`)}>Подробнее</Button>
                            </div>
                        </div>
                    ))}
                </div>
