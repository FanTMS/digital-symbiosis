    ...
    <div className="pb-16 pt-2">
      <div className="px-4 mb-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-2 mb-4 justify-between">
            <div className="flex gap-2">
              <Button variant="primary" leftIcon={<Plus size={18} />} className="px-3 py-1 text-sm sm:text-base sm:px-4 sm:py-2" onClick={handleCreateService}>Создать</Button>
              <Button variant="outline" leftIcon={<FileText size={18} />} className="px-3 py-1 text-sm sm:text-base sm:px-4 sm:py-2" onClick={() => navigate('/orders')}>Мои заказы</Button>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-2 mb-4 justify-center">
          <button
            className={`px-4 py-2 rounded-full font-semibold transition border ${roleFilter === 'all' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-700'}`}
            onClick={() => setRoleFilter('all')}
          >
            Все
          </button>
          <button
            className={`px-4 py-2 rounded-full font-semibold transition border ${roleFilter === 'provider' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-700'}`}
            onClick={() => setRoleFilter('provider')}
          >
            Исполнители
          </button>
          <button
            className={`px-4 py-2 rounded-full font-semibold transition border ${roleFilter === 'client' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-700'}`}
