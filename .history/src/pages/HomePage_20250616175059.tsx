    ...
    <div className="pb-20 sm:pb-24 pt-2">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <motion.div
            ...
            onClick={() => navigate("/services")}
          >
            <div className="absolute right-4 top-4 opacity-10 text-white text-6xl pointer-events-none select-none">
              <Search size={64} />
            </div>
            <div className="flex items-center gap-3 mb-2">
              <Search size={28} className="text-white drop-shadow" />
              <h3 className="font-bold text-white text-lg drop-shadow">Найти услугу</h3>
            </div>
            <p className="text-white/80 text-sm">Выберите из каталога</p>
          </motion.div>
          <motion.div
            variants={item}
            whileTap={{ scale: 0.97 }}
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-2">
              <Plus size={28} className="text-white drop-shadow" />
              <h3 className="font-bold text-white text-lg drop-shadow">Предложить услугу</h3>
            </div>
            <p className="text-white/80 text-sm">Поделитесь своими навыками</p>
          </motion.div>
          <motion.div
            variants={item}
            whileTap={{ scale: 0.97 }}
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-bold text-white text-lg drop-shadow">Пригласить друга</h3>
            </div>
            <p className="text-white/80 text-sm">+5 кредитов за каждого</p>
          </motion.div>
          <motion.div
            variants={item}
            whileTap={{ scale: 0.97 }}
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-bold text-white text-lg drop-shadow">Мои достижения</h3>
            </div>
            <p className="text-white/80 text-sm">Проверьте уровень</p>
          </motion.div>
        </div>
      </motion.div>
      ...
      <div className="px-4 mb-6">
        <div className="bg-white rounded-2xl shadow-card p-6">
          <h2 className="text-lg font-bold mb-4 text-blue-900">Как это работает?</h2>
          <ol className="space-y-3 list-decimal list-inside text-gray-700">
            <li><b>Зарегистрируйтесь</b> или войдите в свой аккаунт.</li>
            <li><b>Найдите услугу</b> или специалиста через поиск или каталог.</li>
            <li><b>Оформите заказ</b> — опишите задачу и оплатите.</li>
            <li><b>Получите результат</b> и оставьте отзыв.</li>
            <li><b>Предлагайте свои услуги</b> и зарабатывайте!</li>
          </ol>
        </div>
      </div>
