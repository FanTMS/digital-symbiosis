    ...
    return (
            ...
            >
              <div className="w-full max-w-md mx-auto px-2 sm:px-0 mt-2">
                ...
                {/* Провайдер */}
                <div className="bg-white p-4 rounded-3xl shadow-lg flex items-center gap-4 mb-5 transition-all duration-300 hover:shadow-2xl hover:scale-[1.015]">
                    ...
                    <div className="flex flex-col gap-4">
                      {reviews.map((review, idx) => (
                        <div key={idx} className="flex gap-3 items-start bg-blue-50/40 rounded-2xl p-3 transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
                          <Avatar src={review.user_avatar_url} name={review.user_name} size={40} className="border" />
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
