      ...
      <div className="px-4 mb-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="primary" leftIcon={<Plus size={18} />} onClick={handleCreateService}>Создать</Button>
            <Button variant="outline" leftIcon={<FileText size={18} />} onClick={() => navigate('/orders')}>Мои заказы</Button>
          </div>
        </div>
